...
template MastermindVariation() {
  ...
  // Number Mastermind: we already take numbers, but 
  // we give the guess sum hint to the player.
   ...
   // Public inputs
    ...
    // VARIATION: Enforce the clue
    clue <== privSolnA + privSolnB + privSolnC + privSolnD;
}
